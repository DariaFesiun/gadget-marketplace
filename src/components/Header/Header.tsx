    ...
    <header className={styles.header}>
      <div className={styles.inner}>
        <div className={styles.left}>
          <Link to="/" className={styles.logo}>
            <img src={`./img/logo-${theme}.png`} alt="Phone Catalog Logo" />
          </Link>
        ...
        <div className={styles.right}>
          <button
            ...
            aria-label="Menu"
          >
            <img src={`./img/icons/burger-${theme}.svg`} />
          </button>
          <NavLink
            to="/favorites"
            className={({ isActive }) =>
      ...
      {isMenuOpen && (
        <div className={styles.mobileMenu}>
          <div className={styles.mobileMenuHeader}>
            ...
            >
              <img src={`./img/icons/close-${theme}.svg`} alt="Close" />
            </button>
          </div>
      ...
      {isMenuOpen && (
        <div className={styles.mobileTabBar}>
          ...
          >
            <img src={`./img/icons/cart-icon-${theme}.svg`} alt="Cart" />
            {cartCount > 0 && (
              <span className={styles.counter}>{cartCount}</span>
            )}
          </NavLink>
